...
!function (e) {
    ...
    s.toolbox = {
        ...
        feature: {
            mark: {
                show: !1,
                title: {mark: "è¾…åŠ©çº¿å¼€å…³", markUndo: "åˆ é™¤è¾…åŠ©çº¿", markClear: "æ¸…ç©ºè¾…åŠ©çº¿"},
                lineStyle: {width: 1, color: "#1e90ff", type: "dashed"}
            },
            dataZoom: {show: !1, title: {dataZoom: "åŒºåŸŸç¼©æ”¾", dataZoomReset: "åŒºåŸŸç¼©æ”¾åŽé€€"}},
            dataView: {show: !1, title: "æ•°æ®è§†å›¾", readOnly: !1, lang: ["æ•°æ®è§†å›¾", "å…³é—­", "åˆ·æ–°"]},
            magicType: {
                show: !1,
                title: {
                    line: "æŠ˜çº¿å›¾åˆ‡æ¢",
            ...
            restore: {show: !1, title: "è¿˜åŽŸ"},
            saveAsImage: {show: !1, title: "ä¿å­˜ä¸ºå›¾ç‰‡", type: "png", lang: ["ç‚¹å‡»ä¿å­˜"]}
        }
    };
    ...
    return n.prototype = {
        type: "text", brush: function (e, i) {
            ...
            if (i && (n = this.getHighlightStyle(n, this.highlightStyle || {})), "undefined" != typeof n.text && n.text !== !1) {
                ...
                var a, o = (n.text + "").split("\n"), r = t.getTextHeight("å›½", n.textFont), s = this.getRect(n), l = n.x;
    ...
    function i(t, i, n, a, o, r) {
        var s = e("../tool/area"), l = s.getTextWidth(t, a), h = s.getTextHeight("å›½", a);
        switch (t = (t + "").split("\n"), o) {
            case"end":
            case"right":
                i -= l;
