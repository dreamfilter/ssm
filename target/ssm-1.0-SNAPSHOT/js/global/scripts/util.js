...
/**
 * @description String方法扩展，判断经过trim的字符串是否为非空，若为空则为true
 * @return {bool}
...
/**
 * @description String方法扩展，判断经过trim的字符串是否为非空，若不为空则为true
 * @return {bool}
 * @example  "  ".isNotEmpty()  返回："false"  "null".isNotEmpty()  返回："false"
 */
 ...
 * @return {boolean} 符合规则则为true
 * @example "2.3".checkNum(1,2).bool 返回true
 */
String.prototype.checkNum = function (intLength, floatLength) {
    ...
    return !!(isInt.test(value) || isFloat.test(value));
};
/**
 ...
 * @param {int} floatLength 小数部分位数(可选参数，若不传入则为0)
 * @return {boolean} 符合规则则为true
 * @example var a=2.3; a.checkNum(1,2) 返回true
 */
Number.prototype.checkNum = String.prototype.checkNum;
/**
